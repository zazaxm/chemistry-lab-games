...
class GameManager {
    ...
    setupEventListeners() {
        ...
        // Results screen
        document.getElementById('playAgain').addEventListener('click', () => this.backToMenu());
        document.getElementById('backToMenuFromResults').addEventListener('click', () => this.backToMenu());
    }
    ...
    saveScore(gameType, score, time, accuracy) {
        const scoreData = {
